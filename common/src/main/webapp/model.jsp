...
<head>
    ...
    <meta name="expires" content="Mon,14 Oct 2019 00:20:00 GMT"><!--设定网页的到期时间，一旦过期则必须到服务器上重新调用。必须使用GMT时间格式-->
    ...
    <meta http-equiv="set-cookie" contect="Mon,14 Oct 2019 00:20:00 GMT"><!--cookie设定，如果网页过期，存盘的cookie将被删除。必须使用GMT时间格式，用于jsp-->
...
<br>
<img src="img/beian.png" alt="beian"><a href="http://www.miitbeian.gov.cn/">湘ICP备18023926号</a>
</body>
</html>
